...
Este laboratorio combinó a lo largo de un mes (1) la perspectiva filosófica de Tim Ingold —quien concibe al mundo como un entramado de lineas de vida que se enredan unas con otras—, con (2) trabajo de campo en el Humedal la Conejera en Bogotá, y (3) un proceso de programación de agentes autónomos utilizando LLMs.
